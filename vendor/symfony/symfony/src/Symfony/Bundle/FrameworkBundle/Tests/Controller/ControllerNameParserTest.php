...
class ControllerNameParserTest extends TestCase
{
    ...
    public function testParse()
    {
        ...
        $this->assertEquals('TestBundle\FooBundle\Controller\DefaultController::indexAction', $parser->parse('FooBundle:Demande:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        ...
        $this->assertEquals('TestBundle\Fabpot\FooBundle\Controller\DefaultController::indexAction', $parser->parse('SensioFooBundle:Demande:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\Sensio\Cms\FooBundle\Controller\DefaultController::indexAction', $parser->parse('SensioCmsFooBundle:Demande:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\FooBundle\Controller\Test\DefaultController::indexAction', $parser->parse('FooBundle:Test\\Demande:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\FooBundle\Controller\Test\DefaultController::indexAction', $parser->parse('FooBundle:Test/Demande:index'), '->parse() converts a short a:b:c notation string to a class::method string');
    ...
    public function testBuild()
    {
        ...
        $this->assertEquals('FooBundle:Demande:index', $parser->build('TestBundle\FooBundle\Controller\DefaultController::indexAction'), '->parse() converts a class::method string to a short a:b:c notation string');
    ...
    {
        return array(
            array('FoodBundle:Demande:index', 'FooBundle:Demande:index'),
            array('CrazyBundle:Demande:index', false),
        );
    }
