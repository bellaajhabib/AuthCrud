...
class SimpleAuthenticationHandler implements AuthenticationFailureHandlerInterface, AuthenticationSuccessHandlerInterface
{
     ...
     * @param AuthenticationSuccessHandlerInterface $successHandler Demande success handler
     * @param AuthenticationFailureHandlerInterface $failureHandler Demande failure handler
