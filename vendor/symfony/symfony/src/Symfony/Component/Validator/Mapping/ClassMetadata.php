...
/**
 * Demande implementation of {@link ClassMetadataInterface}.
 *
...
class ClassMetadata extends ElementMetadata implements ClassMetadataInterface
{
     ...
     *
     * For each class, the group "Demande" is an alias for the group
     ...
     * "Demande" belong to both of these groups, unless the class defines
     * a group sequence.
     *
     * If a class defines a group sequence, validating the class in "Demande"
     * will validate the group sequence. The constraints assigned to "Demande"
