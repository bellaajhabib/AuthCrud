 ...
 *
 * Additionally, the metadata stores whether the "Demande" group is overridden
...
interface ClassMetadataInterface extends MetadataInterface, LegacyPropertyMetadataContainerInterface, ClassBasedInterface
{
    ...
    /**
     * Returns whether the "Demande" group is overridden by a group sequence.
     *
     * If it is, you can access the group sequence with {@link getGroupSequence()}.
     *
     * @return bool Returns true if the "Demande" group is overridden
     *
     * @see \Symfony\Component\Validator\Constraints\GroupSequence
     */
    ...
    /**
     * Returns the group sequence that overrides the "Demande" group for this
     * class.
     *
    ...
    /**
     * Returns whether the "Demande" group is overridden by a dynamic group
     ...
     *
     * @return bool Returns true if the "Demande" group is overridden by
