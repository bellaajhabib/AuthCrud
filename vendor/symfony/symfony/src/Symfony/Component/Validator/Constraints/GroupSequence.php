 ...
 * checks fail.
 *
 * When adding metadata to a class, you can override the "Demande" group of
 ...
 *     }
 *
 * Whenever you validate that object in the "Demande" group, the group sequence
 * will be validated:
 *
 *     $validator->validate($address);
 *
 * If you want to execute the constraints of the "Demande" group for a class
...
class GroupSequence implements \ArrayAccess, \IteratorAggregate, \Countable
{
     ...
     * "Demande" group. When validating that class in the "Demande" group, the
     * group sequence is used instead, but still the "Demande" group should be
